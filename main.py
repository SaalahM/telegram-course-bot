...
ADMIN_IDS = [1075393475, 6725538589,7331434605]  # Add additional numeric Telegram IDs separated by commas
...
async def course_overview(update: Update, context: ContextTypes.DEFAULT_TYPE):
    overview_text = (
        ...
        "<blockquote>🔰 PREPARED BY <b>2016-BATCH OF PHARMACY MUSLIM STUDENTS</b>\n Hosted by:CHMS-MSJ</blockquote>\n\n"
        "                                             FI AMANILLAH 🍃"
    )
...
async def start_reg(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        "<blockquote> <b> الســـــــــــلام عليكم ورحمة اللــــــه وبركــــــــــــــــــــــــــاته 👋</b></blockquote>\n\n"
